    ...
    const signUp = async (form)  =>  { 
      ...
      axios.post(`${config.SERVER_URL}/auth/local/register`, {
          ...
          axios
              ...
              experiencedNetBuilder: (form.Trained === 'trained' ? true : false ),
      ...
      .catch(error => {
          ...
          console.log(error);
          setLoad(false);
          setModal({open: true, title: 'Sorry, that account is already taken, You may send your concern to us by clicking proceed.', function: ()=>{router.push('/support')}})
